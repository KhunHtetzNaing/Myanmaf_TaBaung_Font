...
Sub b1_Click
	...
	'	If File.Exists(File.DirRootExternal & "/MIUI/theme","TaBaung.mtz") = True Then File.Delete(File.DirRootExternal,"MIUI/theme/TaBaung.mtz")
	'	File.Copy(File.DirAssets,"TaBaung.mtz",File.DirRootExternal & "/MIUI/theme","TaBaung.mtz")
