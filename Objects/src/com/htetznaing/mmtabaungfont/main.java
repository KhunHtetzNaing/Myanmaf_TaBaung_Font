...
public class main extends Activity implements B4AActivity{
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		if (isFirst) {
			processBA = new BA(this.getApplicationContext(), null, null, "com.htetznaing.mmtabaungfont", "com.htetznaing.mmtabaungfont.main");
	...
	private void afterFirstLayout() {
        if (this != mostCurrent)
			return;
		activityBA = new BA(this, layout, processBA, "com.htetznaing.mmtabaungfont", "com.htetznaing.mmtabaungfont.main");
        ...
        if (BA.isShellModeRuntimeCheck(processBA)) {
			...
			processBA.raiseEvent2(null, true, "CREATE", true, "com.htetznaing.mmtabaungfont.main", processBA, activityBA, _activity, anywheresoftware.b4a.keywords.Common.Density, mostCurrent);
...
mostCurrent._tlb.Initialize(mostCurrent.activityBA,"tlb");
 //BA.debugLineNum = 98;BA.debugLine="tlb.Text = \"Myanmar TaBaung Font\"";
mostCurrent._tlb.setText((Object)("Myanmar TaBaung Font"));
 //BA.debugLineNum = 99;BA.debugLine="tlb.Color = Colors.rgb(3, 169, 244)";
...
mostCurrent._tlb.setTextColor(anywheresoftware.b4a.keywords.Common.Colors.White);
 //BA.debugLineNum = 101;BA.debugLine="tlb.TextSize = 20";
...
mostCurrent._copy.clrText(mostCurrent.activityBA);
 //BA.debugLineNum = 285;BA.debugLine="copy.setText(\"#Myanmar_TaBaung_Font App! Beautifu";
...
mostCurrent._copy.clrText(mostCurrent.activityBA);
 //BA.debugLineNum = 263;BA.debugLine="copy.setText(\"#Myanmar_TaBaung_Font App! Beauti";
mostCurrent._copy.setText(mostCurrent.activityBA,"#Myanmar_TaBaung_Font App! Beautiful Myanmar Zawgyi Font Style!	You can Use in Samung, Oppo,Vivo, Huawei (EMUI) and Xiaomi (MIUI) without Root Access!!!! Download Free at : http://www.htetznaing.com/search?q=Myanmar+TaBaung+Font");
